...
void loop() {
  ...
  drivetrain.drive(11, 0, yaw, resetDrive);                        //drive 1' to 1st line
  ...
  drivetrain.drive(17, 0, yaw, resetDrive);                         //drive till reach dark blue color and drive to all colors and go back to white square
